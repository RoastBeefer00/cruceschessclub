...
<section class="min-h-screen">
  ...
  >
    <div class="container mx-auto px-4 pt-12 pb-16 max-w-7xl">
      <div class="text-center space-y-6">
        ...
        >
          Looking to improve your game? We've got you covered. No matter where
          you are on your chess journey, we have a coach who can guide you to
          victory.
        </p>
      </div>
    </div>
  ...
  <div class="container mx-auto px-4 pt-16 pb-16 max-w-7xl">
    <div
