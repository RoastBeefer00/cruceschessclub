...
<div
  class="bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 m-4 overflow-hidden border border-gray-200"
>
  <div class="flex flex-row items-stretch">
    <div
      class="w-1/3 flex-shrink-0 p-6 bg-gradient-to-br from-gray-50 to-white"
    >
    ...
    <div class="flex-1 flex flex-col">
      <div class="bg-gradient-to-r from-gray-800 to-gray-900 text-white p-6">
        <h3 class="text-3xl font-bold tracking-tight">{person.Name}</h3>
