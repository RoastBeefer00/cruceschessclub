...
<section class="min-h-screen">
  ...
  <div class="container mx-auto px-4 pt-16 pb-16 max-w-6xl">
    ...
    <div class="flex justify-center mb-8">
      <div
        class="inline-flex gap-2 bg-white rounded-full shadow-lg p-2 border border-gray-200"
      >
        <button
          class="px-6 py-3 rounded-full font-semibold transition-all {$month ==
    ...
    <div class="max-w-4xl mx-auto">
      {#if $month == current_date.getMonth()}
        <Calendar
          ...
          serverEvents={data.calendarEvents[$month] || []}
        />
      {/if}
